            ...
            if args.use_mcts:
                try:
                    ...
                    MCTS = mcts.BatchedMCTS(tokenizer, policy, value_model, ref_policy, reward,
                                            ...
                                            init_v_with_parent=args.init_v_with_parent, kl_coef=args.kl_coef, clamp_kl=True,
                                            sample=False, topp=1.0, reward_gain=1.0, reward_bias=0.0,
                                            disable_cache=False, is_seq2seq=False,
